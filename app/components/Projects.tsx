...
const projects = [
  {
    ...
    description: "A mobile app that helps UiTM Puncak Alam students find dining place based on preferences.",
    img: "/dining-app.svg",
    href: "#",
    iconLists: ["/flutter.svg", "/dart.svg", "/sqlite.svg"], // Example tech icons
  },
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-16 mt-10">
        {projects.map((project) => (
          <div
            ...
            key={project.id}
          >
            <PinContainer title="Visit" href={project.href}>
